...
export const PLUGIN_ICON_LIST: Record<string, any> = {
  ...
  'ai-proxy': <IconFont name="iconapi-breaker" />,
  'ai-proxy-multi': <IconFont name="iconapi-breaker" />,
  'ai-rag': <IconFont name="iconapi-breaker" />,
  'ai-request-rewrite': <IconFont name="iconapi-breaker" />,
  'ai-prompt-guard': <IconFont name="iconapi-breaker" />,
};
