...
export default {
  ...
  'component.pluginForm.limit-count.redis_username.tooltip': 'When using the redis policy, this property specifies the username of the Redis server.',
  'component.pluginForm.limit-count.redis_ssl.tooltip': 'When using the redis policy, whether to enable SSL.',
  'component.pluginForm.limit-count.redis_ssl_verify.tooltip': 'When using the redis policy, whether to verify SSL certificate.',
  'component.pluginForm.limit-count.redis_keepalive_timeout.tooltip': 'When using the redis policy, the idle timeout in milliseconds of the connection to the Redis server.',
  'component.pluginForm.limit-count.redis_keepalive_pool.tooltip': 'When using the redis policy, the size of the connection pool to the Redis server.',
